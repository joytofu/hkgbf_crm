...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\ProfileType A AppBundle\Form\ProfileType instance.
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('upload_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('upload_product', $e, $a, $b));
        $f->addEventSubscriber(new \FOS\UserBundle\Doctrine\Orm\UserListener($this));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('upload_product', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('upload_product', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('upload_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('upload_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('upload_product', $e, $a, $b));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'hkgbf_crm', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5f02b4e59bf4c34d52c1eed84a1cf572e4c678689c4015aa08b4753951d568f5');
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.entity_manager'), 'AppBundle\\Entity\\Group');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('hkgbfmail@163.com' => 'HKGBF'), 'resetting' => array('hkgbfmail@163.com' => 'Resetting Password'))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/userdetail/');
        ...
        $l->add($j, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $l->add($k, array(0 => 'ROLE_AGENT'), NULL);

        $m = new \Symfony\Component\Security\Core\User\InMemoryUserProvider();
        $m->createUser(new \Symfony\Component\Security\Core\User\User('kcswag', 'jntz020', array(0 => 'ROLE_SUPER_ADMIN')));
        ...
        $p->setOptions(array('default_target_path' => 'redirectAfterLogin', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('hkgbfmail@163.com');
        $a->setPassword('oqyljewrdqmlmiia');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.163.com');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig', 2 => 'FOSUserBundle:Form:fields.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig', 2 => 'FOSUserBundle:Form:fields.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dffee3a02b3dff8efa7b4203cc9a0ac9c3a54b4b');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_REGULAR' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_AGENT' => array(0 => 'ROLE_AGENT'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH', 2 => 'ROLE_AGENT')));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('upload_image' => array('uri_prefix' => '/img/upload', 'upload_destination' => ($this->targetDirs[2].'/../web/img/upload'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => NULL, 'directory_namer' => NULL, 'db_driver' => 'orm'), 'upload_product' => array('uri_prefix' => '/product/upload', 'upload_destination' => ($this->targetDirs[2].'/../web/product/upload'), 'inject_on_load' => true, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => NULL, 'directory_namer' => NULL, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'hkgbf_crm',
            'database_user' => 'root',
            'database_password' => NULL,
            'database_path' => ($this->targetDirs[2].'/data/hkgbf-crm.sqlite'),
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.163.com',
            'mailer_user' => 'hkgbfmail@163.com',
            'mailer_password' => 'oqyljewrdqmlmiia',
            'secret' => 'dffee3a02b3dff8efa7b4203cc9a0ac9c3a54b4b',
            'locale' => 'zh_CN',
            ...
            'kernel.secret' => 'dffee3a02b3dff8efa7b4203cc9a0ac9c3a54b4b',
            ...
            'twig.form.resources' => array(
                ...
                2 => 'FOSUserBundle:Form:fields.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.163.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'hkgbfmail@163.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'oqyljewrdqmlmiia',
            ...
            'assetic.node.bin' => 'F:\\Program Files\\nodejs\\\\node.EXE',
            ...
            'fos_user.resetting.email.from_email' => array(
                'hkgbfmail@163.com' => 'Resetting Password',
            ),
            ...
            'vich_uploader.mappings' => array(
                'upload_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[2].'/../web/img/upload'),
                ...
                'upload_product' => array(
                    'uri_prefix' => '/product/upload',
                    'upload_destination' => ($this->targetDirs[2].'/../web/product/upload'),
                    'inject_on_load' => true,
                    'delete_on_update' => true,
                    'delete_on_remove' => true,
                    'namer' => NULL,
